...
- ✅ mo.tumati.me (Mo Fitness App)
- ✅ taskflow.tumati.me (future)
- ✅ Any other \*.tumati.me apps you create
...
```
clerk.tumati.me → frontend-api.clerk.services
accounts.tumati.me → accounts.clerk.services
clkmail.tumati.me → mail.2dmiwn3hlziy.clerk.services
clk._domainkey.tumati.me → dkim1.2dmiwn3hlziy.clerk.services
clk2._domainkey.tumati.me → dkim2.2dmiwn3hlziy.clerk.services
```
...
- ✅ Production keys in use (no development key warnings)
- ✅ Custom domain with SSL certificates
- ✅ Email sending configured via Clerk
- ✅ All deprecated props replaced (fallbackRedirectUrl)
...
- Solution: Verify both keys are from "Tumati Apps" → Production
...
- Check that no old NEXT*PUBLIC_CLERK_AFTER*\* env vars exist
...
**Remember:** This is a shared auth system for ALL your tumati.me apps. Don't create separate Clerk applications for each app - just reuse these keys! 🎉
